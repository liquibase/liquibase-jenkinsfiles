   ...
   stage ('liquibase commands'){
      steps {
        sh '''
          ...
          export LIQUIBASE_COMMANDS_DEFAULTS_FILE="${ENVIRONMENT}/liquibase.properties"
          export LIQUIBASE_COMMAND_CHANGELOG_FILE="${CHANGLOGFILE}"
          export LIQUIBASE_COMMAND_CLASSPATH="${CLASSPATH}"
